> **OWNER MANDATE 2026-09-25 (supersedes conflicting purpose/priorities below):** K-Trader researches and issues trade scenarios; K_AI alone executes. Historical strategy R&D begins with at least one year, longer for slower horizons. Approved initial Binance USD-M screening cohort: BTCUSDT, ETHUSDT, SOLUSDT, XRPUSDT, BNBUSDT. After eligibility verification, isolated history acquisition is authorized. See [mandate](research/K_TRADER_OWNER_RESEARCH_MANDATE_20260925.md) and [research plan](research/PHASE11G_HISTORY_FIRST_LEVEL_STRATEGY_PLAN_20260925.md). Existing frozen prospective evidence and ongoing first-seen data-only epoch remain isolated. No HP-OMEN use or live trading.

# K-Trader Current State

> **CHAT TRANSITION CHECKPOINT 2026-09-25 (final sync before owner-supplied bootstrap generator):** [history-first project freeze](checkpoints/2026-09-25_CHAT_TRANSITION_HISTORY_FIRST.md). Owner priority: **independent historical Binance USD-M recovery for strategy R&D/backtesting first; separately recorded current first-seen data for later independently approved prospective shadow testing second.** Immediate next gate is H0 existing historical dataset inventory, then bounded isolated H1 5×5 history pilot. Final read-only host verification at **2026-09-25T15:23Z**: production health `ok`, `read_only`, `data_ready=true`, provider `binance_usdm`; collector PID `119664` and monitor PID `121255` each single and active; **15** completed M15 first-seen cutoffs from 11:45Z through 15:15Z; latest collector state `PASS`, 5/19 ready and 14/19 rejected; real post-activation monitor reports **14:06Z PASS** and **15:06Z PASS**; legacy accepted-state and ledger SHA pins unchanged. GitHub Actions quota unavailable until 2026-10-01; **do not use HP-OMEN directly or indirectly**, do not issue reminders, restart/backfill the first-seen epoch, open holdout, promote new prospective families or trade. Older 2026-09-17/16 pointers lower in this document are historical and do not override this checkpoint.

> **Research priority (owner confirmed 2026-09-25):** [six-month historical recovery → independently validated strategy → separate forward shadow evaluation](research/PHASE11G_HISTORICAL_RECOVERY_AND_PROSPECTIVE_STRATEGY_PLAN_20260925.md). Historical exchange data are for development/backtests, never retroactive first-seen evidence. Current first-seen data-only epoch + approved non-notifying monitor stay isolated for contemporary quality and later frozen-strategy prospective validation. Immediate gate is H0 read-only inventory and H1 bounded separate provider-history pilot; GitHub Actions quota remains unavailable to 2026-10-01, HP-OMEN prohibited, trading not authorized.

> **Approved automated server monitoring ACTIVE / baseline PASS (2026-09-25 ~13:20Z):** [checkpoint](checkpoints/2026-09-25_PHASE11G_MONITOR_ACTIVE_BASELINE.md). One collector + one monitor process, six eligible first-seen cutoffs verified in baseline, all six immutable pins matched; two hourly slots predating activation explicitly marked MISSED, not backfilled. Next future hourly check scheduled for 14:06Z, deep for 15:51Z; first future report still requires verification. **Observed separate data-quality concern:** 13:15Z first-seen cutoff had only 1/19 ready due to missing timely M15/M5 closed bars; never retrofit late data. No reminders, no HP-OMEN, no new prospective families (legacy remains 54/100).
